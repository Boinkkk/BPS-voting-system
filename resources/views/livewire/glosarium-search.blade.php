<div>
    ...
    <div class="mb-6 relative">
        <div class="relative max-w-md">
            <input 
                ...
                placeholder="Cari istilah atau penjelasan di glosarium..." 
    ...
    <!-- Glosarium Cards Container -->
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($glosariums as $item)
                    <div 
                        onclick="openGlosariumModal('{{ htmlspecialchars($item->istilah, ENT_QUOTES, 'UTF-8') }}', `{{ htmlspecialchars(nl2br(e($item->definisi)), ENT_QUOTES, 'UTF-8') }}`)" 
                    ...
                    >
                        <h3 class="text-lg font-semibold text-bps-secondary group-hover:text-blue-700 transition-colors mb-2">{{ $item->istilah }}</h3>
                        <p class="text-sm text-gray-600 leading-relaxed line-clamp-3">
                            {{ \Illuminate\Support\Str::limit($item->definisi, 120) }}
                        </p>
                ...
                @empty
                    <div class="col-span-full py-12 text-center text-gray-500">
                        ...
                        <p class="text-gray-600 font-medium">Tidak ada istilah glosarium yang cocok.</p>
                        @if(!empty($search))
