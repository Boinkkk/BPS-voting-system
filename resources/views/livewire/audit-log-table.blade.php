<div>
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select wire:model.live="module" id="module" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-bps-secondary focus:border-bps-secondary block w-full p-2">
            ...
            <div>
                ...
                <select wire:model.live="causer_id" id="causer_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-bps-secondary focus:border-bps-secondary block w-full p-2">
            ...
            <div>
                ...
                <input type="date" wire:model.live="date_start" id="date_start" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-bps-secondary focus:border-bps-secondary block w-full p-2">
            </div>

            <!-- Tanggal Sampai & Tombol Reset -->
            <div class="flex flex-col justify-end">
                <label for="date_end" class="block text-xs font-medium text-gray-700 mb-1">Sampai Tanggal</label>
                <div class="flex gap-2">
                    <input type="date" wire:model.live="date_end" id="date_end" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-bps-secondary focus:border-bps-secondary block w-full p-2">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden relative">
        <!-- Loading Overlay -->
        <div wire:loading.flex class="absolute inset-0 z-20 items-center justify-center bg-white/50 backdrop-blur-xs">
                        ...
                        <tr>
                            <td colspan="4" class="px-5 py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-400">
                                    ...
                                    <button wire:click="resetFilters" class="mt-4 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">Reset Filter</button>
                                </div>
                            </td>
                        </tr>
                    @endforelse
