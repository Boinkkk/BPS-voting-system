...
<body class="bg-gray-50 font-sans antialiased text-slate-800 h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex-shrink-0 flex flex-col h-full z-20 shadow-sm relative">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
            ...
            <a href="{{ route('admin.pegawai.index') }}" class="flex items-center space-x-3 p-3 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.pegawai.*') ? 'bg-[#0091d5] text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                <span>Manajemen Pegawai</span>
            </a>

            <a href="{{ route('admin.absensi.index') }}" class="flex items-center space-x-3 p-3 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.absensi.*') ? 'bg-[#0091d5] text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                <span>Absensi Pegawai</span>
            </a>

            <a href="{{ route('admin.kandidat.index') }}" class="flex items-center space-x-3 p-3 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.kandidat.*') ? 'bg-[#0091d5] text-white shadow-md shadow-blue-500/20' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
