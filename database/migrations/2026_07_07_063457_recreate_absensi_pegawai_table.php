...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Buat tabel absensi_pegawai baru untuk menyimpan rekap bulanan
        Schema::create('absensi_pegawai', function (Blueprint $table) {
            ...
            // Akan disimpan dalam menit untuk perhitungan, meski excelnya bisa format HH:MM
            ...
            // Constraint agar tiap pegawai hanya punya 1 rekap per bulan di tiap periode
    ...
    {
        Schema::dropIfExists('absensi_pegawai');
        // Tidak merevert tabel tipe_absen karena sudah di-deprecate
    }
};
